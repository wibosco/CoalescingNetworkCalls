    ...
    override func main() {
        ...
        do {
            ...
            ServiceManager.sharedInstance.backgroundManagedObjectContext.performBlockAndWait({ () -> Void in
                let mapper = QuestionsMapper(managedObjectContext: ServiceManager.sharedInstance.backgroundManagedObjectContext)
                let page = mapper.mapQuestions(jsonResponse) as Page
